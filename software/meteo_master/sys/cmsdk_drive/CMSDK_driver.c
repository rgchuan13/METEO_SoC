 ...
 */
 ...
 void CMSDK_timer_EnableIRQ(CMSDK_TIMER_TypeDef* CMSDK_TIMERx)
 {
       CMSDK_TIMERx->CTRL |= CMSDK_TIMER_CTRL_IRQEN_Msk;
 }
 ...
 */
 ...
 void CMSDK_timer_DisableIRQ(CMSDK_TIMER_TypeDef* CMSDK_TIMERx)
 {
       CMSDK_TIMERx->CTRL &= ~CMSDK_TIMER_CTRL_IRQEN_Msk;
 }
 ...
 */
 ...
 void CMSDK_timer_StartTimer(CMSDK_TIMER_TypeDef* CMSDK_TIMERx)
 {
       CMSDK_TIMERx->CTRL |= CMSDK_TIMER_CTRL_EN_Msk;
 }
 ...
 */
 ...
 void CMSDK_timer_StopTimer(CMSDK_TIMER_TypeDef* CMSDK_TIMERx)
 {
       CMSDK_TIMERx->CTRL &= ~CMSDK_TIMER_CTRL_EN_Msk;
 }
 ...
 */
 ...
 uint32_t CMSDK_timer_GetValue(CMSDK_TIMER_TypeDef* CMSDK_TIMERx)
 {
       return CMSDK_TIMERx->VALUE;
 }
 ...
 */
 ...
 void CMSDK_timer_SetValue(CMSDK_TIMER_TypeDef* CMSDK_TIMERx, uint32_t value)
 {
       CMSDK_TIMERx->VALUE = value;
 }
 ...
 */
 ...
 uint32_t CMSDK_timer_GetReload(CMSDK_TIMER_TypeDef* CMSDK_TIMERx)
 {
       return CMSDK_TIMERx->RELOAD;
 }
 ...
 */
 ...
 void CMSDK_timer_SetReload(CMSDK_TIMER_TypeDef* CMSDK_TIMERx, uint32_t value)
 {
       CMSDK_TIMERx->RELOAD = value;
 }
 ...
 */
 ...
 void CMSDK_timer_ClearIRQ(CMSDK_TIMER_TypeDef* CMSDK_TIMERx)
 {
       CMSDK_TIMERx->INTCLEAR = CMSDK_TIMER_INTCLEAR_Msk;
 }
 ...
 */
 ...
 uint32_t  CMSDK_timer_StatusIRQ(CMSDK_TIMER_TypeDef* CMSDK_TIMERx)
 {
       return CMSDK_TIMERx->INTSTATUS;
 }
 ...
 */
  ...
  void CMSDK_timer_Init_IntClock(CMSDK_TIMER_TypeDef* CMSDK_TIMERx, uint32_t reload,
 uint32_t irq_en)
 {
       CMSDK_TIMERx->CTRL = 0;
       CMSDK_TIMERx->VALUE = reload;
       CMSDK_TIMERx->RELOAD = reload;
       if (irq_en!=0)                                                                          /* non zero - enable IRQ */
         CMSDK_TIMERx->CTRL = (CMSDK_TIMER_CTRL_IRQEN_Msk | CMSDK_TIMER_CTRL_EN_Msk);
       else{                                                                                   /* zero - do not enable IRQ */
         CMSDK_TIMERx->CTRL = ( CMSDK_TIMER_CTRL_EN_Msk);                                       /* enable timer */
        }
 }
 ...
 */
 ...
 void CMSDK_timer_Init_ExtClock(CMSDK_TIMER_TypeDef* CMSDK_TIMERx, uint32_t reload,
 uint32_t irq_en)
 {
       CMSDK_TIMERx->CTRL = 0;
       CMSDK_TIMERx->VALUE = reload;
 ...
 */
 ...
 void CMSDK_timer_Init_ExtEnable(CMSDK_TIMER_TypeDef* CMSDK_TIMERx, uint32_t reload,
 uint32_t irq_en)
 {
       CMSDK_TIMERx->CTRL = 0;
       CMSDK_TIMERx->VALUE = reload;
...
void GPIO_SetBit(CMSDK_GPIO_TypeDef* GPIO, uint16_t pin)
{
      GPIO->DATAOUT |= pin;
}

void GPIO_ResetBit(CMSDK_GPIO_TypeDef* GPIO, uint16_t pin)
{
      GPIO->DATAOUT &= ~pin;
}

 uint8_t CMSDK_gpio_ReadBit(CMSDK_GPIO_TypeDef *CMSDK_GPIO, uint16_t GPIO_Pin)
{
      if((CMSDK_GPIO->DATA & GPIO_Pin) != 0)
      {
        return 1;
      }
      else
