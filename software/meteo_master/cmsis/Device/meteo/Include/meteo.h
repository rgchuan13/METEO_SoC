...
#include "system_meteo.h"               /* CMSDK System include file                          */
...
typedef struct
{
  __O   uint32_t  SEG_DATA;             /*!< Offset: 0x000 seg Register (/W) */
  __I   uint32_t  KEY_DATA;             /*!< Offset: 0x004 keyboard Register (R/) */
...
typedef struct
{
  __I   uint32_t  RSSI_STATE;             /*!< Offset: 0x000 RSSI Register (/R) */
  __O   uint32_t  PWM_CONTROL;             /*!< Offset: 0x004 PWM Register (W/) */
...
#define NVIC_SETENA (*(volatile unsigned *) 0xE000E100)   // 中断使能寄存器
#define NVIC_CLRENA (*(volatile unsigned *) 0xE000E180)   // 清除中断使能寄存器
#define NVIC_SETPEND  (*(volatile unsigned *) 0xE000E200) // 中断挂起寄存器
#define NVIC_CLRPEND   (*(volatile unsigned *) 0xE000E280)// 清除中断挂起寄存器
...
typedef struct
{
  __O   uint32_t  LCD_CS;             /*!< Offset: 0x000  (W/) */
  __O   uint32_t  LCD_RS;
  __O   uint32_t  LCD_WR;
  __O   uint32_t  LCD_RD;
  __O   uint32_t  LCD_RST;
  __O   uint32_t  LCD_BL_CTR;
  __O   uint32_t  LCD_DATA;
...
#define SEGKEY_BASE             (CMSDK_AHB_BASE + 0x1000UL)
#define BASEBAND_BASE           (CMSDK_AHB_BASE + 0x2000UL)
#define LCD_BASE                (CMSDK_APB_BASE + 0xC000UL)
...
#define SEGKEY                  ((SEGKEY_TypeDef   *) SEGKEY_BASE        )
